...
import 'package:synccards/model/note.dart';
...
//    var result = await dbClient.rawQuery('SELECT * FROM $tableNote');
  ...
  Future<int> getCount() async {
    var dbClient = await db;
    return Sqflite.firstIntValue(await dbClient.rawQuery('SELECT COUNT(*) FROM $tableNote') ) ?? 0;
  }

  Future<Note?> getNote(int id) async {
    var dbClient = await db;
    List<Map<String,dynamic>> result = await dbClient.query(tableNote,
